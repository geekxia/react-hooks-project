...
const AJAX_PhoneState_LEST = 'AJAX_PhoneState_LEST'
const AJAX_GOOD_LIST = 'AJAX_GOOD_LIST'
const AJAX_GOOD_CATE = 'AJAX_GOOD_CATE'
const AJAX_GOOD_DATAIL='AJAX_GOOD_DATAIL'
